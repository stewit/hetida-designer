...
* `from`: The timestamp from which on datapoints of the source are requested. Can be any valid isoformat, but typically is UTC ("+00:00" or Zulu "Z"), up to nanosecond precision, e.g. "2020-03-11T13:45:18.194000011Z" or "2020-03-11T13:45:18.19+00:00".
